...
public static class CustomSettings
{
	...
	{                
		...
		_GT(typeof(UIMgr)),
		_GT(typeof(MediaMgr)),
		_GT(typeof(CameraRayMgr)),
        _GT(typeof(Profile)),
		_GT(typeof(UIEventHandle)),
		_GT(typeof(CallServer)),
		_GT(typeof(CameraShotInterface)),
		_GT(typeof(RenderObj)),
		_GT(typeof(EffectTime)),
		_GT(typeof(OnHead)),
		_GT(typeof(FloatUIDestroy)),
		_GT(typeof(ScrollCircle)).SetBaseType(typeof(UnityEngine.UI.ScrollRect)),
		_GT(typeof(CDMask)),
		_GT(typeof(FogForGame)),
        _GT(typeof(SDKEntryMgr)),
		//Custom AddEx_(Unity_UI)		
		_GT(typeof(Button)),
		_GT(typeof(Image)),
		...
		_GT(typeof(Graphic)).SetBaseType(typeof(UnityEngine.EventSystems.UIBehaviour)),
