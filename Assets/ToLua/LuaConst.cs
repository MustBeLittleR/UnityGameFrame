...
{
	public static string luaDir = GameConfigMgr.ms_sLuaScriptDir; //Application.dataPath + "/Lua";	//lua逻辑代码目录
	public static string toluaDir = GameConfigMgr.ms_sLuaScriptDir + "Gac/ToLua";					//tolua lua文件目录
	public static string designerDir = GameConfigMgr.ms_sDesignerDir;								//lua配置表路径
